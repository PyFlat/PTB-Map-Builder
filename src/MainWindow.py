...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, dirpath=None):
        ...
        self.actionDraw_Box = QAction(MainWindow)
        self.actionDraw_Box.setObjectName(u"actionDraw_Box")
        self.actionDraw_Box.setCheckable(True)
        ...
        self.menuTools.addAction(self.actionDraw_Box)
...
#if QT_CONFIG(shortcut)
        self.actionDraw_Line.setShortcut(QCoreApplication.translate("MainWindow", u"Alt+L", None))
#endif // QT_CONFIG(shortcut)
        self.actionDraw_Box.setText(QCoreApplication.translate("MainWindow", u"Draw Box", None))
#if QT_CONFIG(shortcut)
        self.actionDraw_Box.setShortcut(QCoreApplication.translate("MainWindow", u"Alt+B", None))
#endif // QT_CONFIG(shortcut)
        self.actionMove_Block.setText(QCoreApplication.translate("MainWindow", u"Move Block", None))
#if QT_CONFIG(shortcut)
        self.actionMove_Block.setShortcut(QCoreApplication.translate("MainWindow", u"Alt+M", None))
#endif // QT_CONFIG(shortcut)
        self.actionDraw_Rect.setText(QCoreApplication.translate("MainWindow", u"Draw Rect", None))
#if QT_CONFIG(shortcut)
        self.actionDraw_Rect.setShortcut(QCoreApplication.translate("MainWindow", u"Alt+R", None))
#endif // QT_CONFIG(shortcut)
