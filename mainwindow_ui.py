...
"}")
        ...
        self.actionMove_Block = QAction(MainWindow)
        self.actionMove_Block.setObjectName(u"actionMove_Block")
        self.actionMove_Block.setCheckable(True)
        ...
        icon2 = QIcon()
        icon2.addFile(u"textures/02_water.gif", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.placeholder0 = QPushButton(self.blocks_page_3)
        self.placeholder0.setObjectName(u"placeholder0")
        self.placeholder0.setIconSize(QSize(25, 25))
        self.placeholder0.setCheckable(True)

        self.verticalLayout_8.addWidget(self.placeholder0)
        ...
        icon16 = QIcon()
        icon16.addFile(u"icons/arrow_left.png", QSize(), QIcon.Normal, QIcon.Off)
        icon16.addFile(u"icons/arrow_left_disabled.png", QSize(), QIcon.Disabled, QIcon.Off)
        ...
        icon17 = QIcon()
        icon17.addFile(u"icons/arrow_right.png", QSize(), QIcon.Normal, QIcon.Off)
        icon17.addFile(u"icons/arrow_right_disabled.png", QSize(), QIcon.Disabled, QIcon.Off)
        ...
        self.menuTools.addAction(self.actionMove_Block)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionMove_Block.setText(QCoreApplication.translate("MainWindow", u"Move Block", None))
